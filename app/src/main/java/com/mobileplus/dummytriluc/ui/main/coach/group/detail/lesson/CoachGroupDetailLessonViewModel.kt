 ...
 */
class CoachGroupDetailLessonViewModel(
    ...
    fun getAllListAssign(classId: Int, page: Int? = null): Disposable {
        isLoading.onNext(true)
        return dataManager.getCoachAssignExercise(classId, page)
            ...
            .subscribe({ response ->
                ...
                logErr("getAllListAssign:$response")
            }, {
                isLoading.onNext(false)
                it.logErr()
    ...
    fun deleteAssign(assignId: Int, classId: Int?): Disposable {
        return dataManager.deleteAssign(assignId, classId)
            .compose(schedulerProvider.ioToMainSingleScheduler())
            .subscribe({ response ->
