...
class ConnectionEventListener {
    ...
    var onReconnect: ((BluetoothDevice) -> Unit)? = null
    ...
    var onCharacteristicWriteFail: ((BluetoothDevice, BluetoothGattCharacteristic) -> Unit)? = null
    ...
    var onMtuChanged: ((BluetoothGatt, Int) -> Unit)? = null
}
